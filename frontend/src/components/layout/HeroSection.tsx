        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-12">
          ...
          {isConnected && (
            <div className="flex-1 w-full max-w-md lg:max-w-lg">
              <div className="bg-white rounded-[8px] shadow-xl border border-[#00B495] p-6 md:p-8 ">
                <div className="text-start font-bold space-y-4 border border-[#00B495] rounded-3xl p-4">
                  <div>
